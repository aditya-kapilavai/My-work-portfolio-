...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Cinematica_JA_reducido_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Cinematica_JA_reducido_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Cinematica_JA_reducido_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Cinematica_JA_reducido") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Cinematica_JA_reducido_autoinheritance_info(nlhs,plhs,2,newRhs);
  }
...
{
  extern unsigned int sf_Cinematica_JA_reducido_get_eml_resolved_functions_info(
  ...
  if (strcmp(machineName, "Cinematica_JA_reducido") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Cinematica_JA_reducido_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_Cinematica_JA_reducido_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Cinematica_JA_reducido")) {
    return(sf_Cinematica_JA_reducido_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Cinematica_JA_reducido_terminator();
    sf_debug_terminate();
  }
...
extern void Cinematica_JA_reducido_register_exported_symbols(SimStruct* S);
extern void Cinematica_JA_reducido_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Cinematica_JA_reducido_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Cinematica_JA_reducido_debug_initialize();
    }

    Cinematica_JA_reducido_initializer();
  }
