...
MACHINE     = SIMULACION_TORQUE
TARGET      = sfun
CHART_SRCS 	= \
     c1_SIMULACION_TORQUE.c\
     c2_SIMULACION_TORQUE.c\
     c3_SIMULACION_TORQUE.c\
     c4_SIMULACION_TORQUE.c\
     c5_SIMULACION_TORQUE.c\
     c6_SIMULACION_TORQUE.c\
     c8_SIMULACION_TORQUE.c\
     c9_SIMULACION_TORQUE.c\
     c10_SIMULACION_TORQUE.c\
     c11_SIMULACION_TORQUE.c
MACHINE_SRC	= SIMULACION_TORQUE_sfun.c
MACHINE_REG = SIMULACION_TORQUE_sfun_registry.c
MEX_WRAPPER =
MAKEFILE    = SIMULACION_TORQUE_sfun.mak
...
OBJLIST_FILE = SIMULACION_TORQUE_sfun.mol
SFCLIB = "C:\Program Files (x86)\MATLAB\R2011a\stateflow\c\mex\lib\win32\sfc_mexmsvc80.lib" "C:\Program Files (x86)\MATLAB\R2011a\stateflow\c\debugger\lib\win32\sfc_debugmsvc80.lib"
AUX_LNK_OBJS =
USER_LIBS =
LINK_MACHINE_LIBS =
