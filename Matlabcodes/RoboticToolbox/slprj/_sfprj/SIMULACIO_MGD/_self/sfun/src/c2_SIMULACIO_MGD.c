...
static const char * c2_debug_family_names[16] = { "d2", "a2", "a3", "a4", "a5",
  "a6", "H", "nargin", "nargout", "q1", "q2", "q3", "q4", "MGD", "xyz", "rt" };

/* Function Declarations */
static void initialize_c2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance);
static void initialize_params_c2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct *
  chartInstance);
static void enable_c2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance);
static void disable_c2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_SIMULACIO_MGD
  (SFc2_SIMULACIO_MGDInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SIMULACIO_MGD
  (SFc2_SIMULACIO_MGDInstanceStruct *chartInstance);
static void set_sim_state_c2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance);
static void sf_c2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct *chartInstance);
static void initSimStructsc2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance);
static void registerMessagesc2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct *chartInstance,
  const mxArray *c2_rt, const char_T *c2_identifier, real_T c2_y[5]);
static void c2_b_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_xyz, const char_T *c2_identifier, real_T
  c2_y[3]);
static void c2_d_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_MGD, const char_T *c2_identifier, real_T
  c2_y[16]);
static void c2_f_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[16]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_g_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_h_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_i_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_SIMULACIO_MGD, const char_T
  *c2_identifier);
static uint8_T c2_j_emlrt_marshallIn(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_SIMULACIO_MGDInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SIMULACIO_MGD = 0U;
}
  ...
  (SFc2_SIMULACIO_MGDInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_SIMULACIO_MGD;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_SIMULACIO_MGD = c2_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_active_c2_SIMULACIO_MGD");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_SIMULACIO_MGD(chartInstance);
...
static void sf_c2_SIMULACIO_MGD(SFc2_SIMULACIO_MGDInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_q1, 0U);
  for (c2_i6 = 0; c2_i6 < 16; c2_i6++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_MGD)[c2_i6], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_b_q2, 2U);
  _SFD_DATA_RANGE_CHECK(*c2_b_q3, 3U);
  _SFD_DATA_RANGE_CHECK(*c2_b_q4, 4U);
  for (c2_i7 = 0; c2_i7 < 3; c2_i7++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_xyz)[c2_i7], 5U);
  }

  for (c2_i8 = 0; c2_i8 < 5; c2_i8++) {
    _SFD_DATA_RANGE_CHECK((*c2_b_rt)[c2_i8], 6U);
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_d2, 0U, c2_d_sf_marshallOut,
    c2_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_a2, 1U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_a3, 2U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_a4, 3U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_a5, 4U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_a6, 5U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_H, 6U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 8U, c2_d_sf_marshallOut,
    c2_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_q1, 9U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_q2, 10U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_q3, 11U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_q4, 12U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_MGD, 13U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_xyz, 14U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_rt, 15U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_SIMULACIO_MGDInstanceStruct *chartInstance;
  chartInstance = (SFc2_SIMULACIO_MGDInstanceStruct *)chartInstanceVoid;
  ...
  c2_y[3])
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_xyz), &c2_thisId, c2_y);
...
const mxArray *sf_c2_SIMULACIO_MGD_get_eml_resolved_functions_info(void)
{
  ...
  (*c2_b_info)[0].fileTimeLo = 1343830372U;
  ...
  (*c2_b_info)[2].fileTimeLo = 1343830386U;
  ...
  (*c2_b_info)[3].fileTimeLo = 1286818736U;
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_SIMULACIO_MGD), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_SIMULACIO_MGD);
  return c2_y;
}
...
void sf_c2_SIMULACIO_MGD_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(969257856U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3660231153U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1147710508U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4061435777U);
}

mxArray *sf_c2_SIMULACIO_MGD_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("97t5bFwRK1idyaIMZgU1sD");
...
mxArray *sf_c2_SIMULACIO_MGD_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_SIMULACIO_MGD(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"MGD\",},{M[1],M[23],T\"rt\",},{M[1],M[20],T\"xyz\",},{M[8],M[0],T\"is_active_c2_SIMULACIO_MGD\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SIMULACIO_MGD_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_SIMULACIO_MGDInstanceStruct *chartInstance;
    chartInstance = (SFc2_SIMULACIO_MGDInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(5,2,0,1,"xyz");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1262);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(5U, *c2_xyz);
...
{
  return "FJ3vu96axIDH9CA5sX1VsD";
}

static void sf_opaque_initialize_c2_SIMULACIO_MGD(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_SIMULACIO_MGDInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_SIMULACIO_MGD((SFc2_SIMULACIO_MGDInstanceStruct*)
    chartInstanceVar);
  initialize_c2_SIMULACIO_MGD((SFc2_SIMULACIO_MGDInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_SIMULACIO_MGD(void *chartInstanceVar)
{
  enable_c2_SIMULACIO_MGD((SFc2_SIMULACIO_MGDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_SIMULACIO_MGD(void *chartInstanceVar)
{
  disable_c2_SIMULACIO_MGD((SFc2_SIMULACIO_MGDInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_SIMULACIO_MGD(void *chartInstanceVar)
{
  sf_c2_SIMULACIO_MGD((SFc2_SIMULACIO_MGDInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_SIMULACIO_MGD(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_SIMULACIO_MGD
    ((SFc2_SIMULACIO_MGDInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_SIMULACIO_MGD();/* state var info */
...
extern void sf_internal_set_sim_state_c2_SIMULACIO_MGD(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_SIMULACIO_MGD((SFc2_SIMULACIO_MGDInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_SIMULACIO_MGD(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_SIMULACIO_MGD(S);
}

static void sf_opaque_set_sim_state_c2_SIMULACIO_MGD(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_SIMULACIO_MGD(S, st);
}

static void sf_opaque_terminate_c2_SIMULACIO_MGD(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SIMULACIO_MGDInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SIMULACIO_MGD_optimization_info();
    }

    finalize_c2_SIMULACIO_MGD((SFc2_SIMULACIO_MGDInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_SIMULACIO_MGD((SFc2_SIMULACIO_MGDInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_SIMULACIO_MGD(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_SIMULACIO_MGD(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1675323519U));
  ssSetChecksum1(S,(3675389618U));
  ssSetChecksum2(S,(3210079743U));
  ssSetChecksum3(S,(179757862U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_SIMULACIO_MGD(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_SIMULACIO_MGD(SimStruct *S)
{
  SFc2_SIMULACIO_MGDInstanceStruct *chartInstance;
  chartInstance = (SFc2_SIMULACIO_MGDInstanceStruct *)utMalloc(sizeof
    (SFc2_SIMULACIO_MGDInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_SIMULACIO_MGDInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_SIMULACIO_MGD;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_SIMULACIO_MGD;
...
void c2_SIMULACIO_MGD_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SIMULACIO_MGD(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SIMULACIO_MGD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SIMULACIO_MGD(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SIMULACIO_MGD_method_dispatcher.\n"
