...
static void initialize_c10_Cinematica_MGI(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance);
static void initialize_params_c10_Cinematica_MGI
  (SFc10_Cinematica_MGIInstanceStruct *chartInstance);
static void enable_c10_Cinematica_MGI(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance);
static void disable_c10_Cinematica_MGI(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_Cinematica_MGI
  (SFc10_Cinematica_MGIInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_Cinematica_MGI
  (SFc10_Cinematica_MGIInstanceStruct *chartInstance);
static void set_sim_state_c10_Cinematica_MGI(SFc10_Cinematica_MGIInstanceStruct *
  chartInstance, const mxArray *c10_st);
static void finalize_c10_Cinematica_MGI(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance);
static void sf_c10_Cinematica_MGI(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance);
static void initSimStructsc10_Cinematica_MGI(SFc10_Cinematica_MGIInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance, const mxArray *c10_rad, const char_T *c10_identifier);
static real_T c10_b_emlrt_marshallIn(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_c_emlrt_marshallIn(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_d_emlrt_marshallIn(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_Cinematica_MGI, const
  char_T *c10_identifier);
static uint8_T c10_e_emlrt_marshallIn(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_Cinematica_MGIInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_Cinematica_MGI = 0U;
}
  ...
  (SFc10_Cinematica_MGIInstanceStruct *chartInstance)
{
  ...
  c10_b_hoistedGlobal = chartInstance->c10_is_active_c10_Cinematica_MGI;
  ...
  chartInstance, const mxArray *c10_st)
{
  ...
  *c10_rad = c10_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c10_u,
    0)), "rad");
  chartInstance->c10_is_active_c10_Cinematica_MGI = c10_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_Cinematica_MGI");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_Cinematica_MGI(chartInstance);
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_Cinematica_MGIInstanceStruct *chartInstance;
  chartInstance = (SFc10_Cinematica_MGIInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_Cinematica_MGI_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c10_identifier)
{
  ...
  c10_y = c10_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_Cinematica_MGI), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_Cinematica_MGI);
  return c10_y;
}
...
/* SFunction Glue Code */
void sf_c10_Cinematica_MGI_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_Cinematica_MGI_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_Cinematica_MGI(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"rad\",},{M[8],M[0],T\"is_active_c10_Cinematica_MGI\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_Cinematica_MGI_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_Cinematica_MGIInstanceStruct *chartInstance;
    chartInstance = (SFc10_Cinematica_MGIInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c10_Cinematica_MGI(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_Cinematica_MGIInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_Cinematica_MGI((SFc10_Cinematica_MGIInstanceStruct*)
    chartInstanceVar);
  initialize_c10_Cinematica_MGI((SFc10_Cinematica_MGIInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_Cinematica_MGI(void *chartInstanceVar)
{
  enable_c10_Cinematica_MGI((SFc10_Cinematica_MGIInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c10_Cinematica_MGI(void *chartInstanceVar)
{
  disable_c10_Cinematica_MGI((SFc10_Cinematica_MGIInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_Cinematica_MGI(void *chartInstanceVar)
{
  sf_c10_Cinematica_MGI((SFc10_Cinematica_MGIInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_Cinematica_MGI(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_Cinematica_MGI
    ((SFc10_Cinematica_MGIInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_Cinematica_MGI();/* state var info */
...
extern void sf_internal_set_sim_state_c10_Cinematica_MGI(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c10_Cinematica_MGI((SFc10_Cinematica_MGIInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_Cinematica_MGI(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_Cinematica_MGI(S);
}

static void sf_opaque_set_sim_state_c10_Cinematica_MGI(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c10_Cinematica_MGI(S, st);
}

static void sf_opaque_terminate_c10_Cinematica_MGI(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_Cinematica_MGIInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c10_Cinematica_MGI((SFc10_Cinematica_MGIInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_Cinematica_MGI((SFc10_Cinematica_MGIInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_Cinematica_MGI(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_Cinematica_MGI(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"Cinematica_MGI","Cinematica_MGI",10);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"Cinematica_MGI","Cinematica_MGI",10,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"Cinematica_MGI",
      "Cinematica_MGI",10,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Cinematica_MGI","Cinematica_MGI",10,
        1);
      sf_mark_chart_reusable_outputs(S,"Cinematica_MGI","Cinematica_MGI",10,1);
    }

    sf_set_rtw_dwork_info(S,"Cinematica_MGI","Cinematica_MGI",10);
...
static void mdlRTW_c10_Cinematica_MGI(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Cinematica_MGI", "Cinematica_MGI",10);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c10_Cinematica_MGI(SimStruct *S)
{
  SFc10_Cinematica_MGIInstanceStruct *chartInstance;
  chartInstance = (SFc10_Cinematica_MGIInstanceStruct *)malloc(sizeof
    (SFc10_Cinematica_MGIInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_Cinematica_MGIInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_Cinematica_MGI;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_Cinematica_MGI;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_Cinematica_MGI;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_Cinematica_MGI;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_Cinematica_MGI;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_Cinematica_MGI;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_Cinematica_MGI;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_Cinematica_MGI;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_Cinematica_MGI;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_Cinematica_MGI;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_Cinematica_MGI;
...
void c10_Cinematica_MGI_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_Cinematica_MGI(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_Cinematica_MGI(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_Cinematica_MGI(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_Cinematica_MGI_method_dispatcher.\n"
