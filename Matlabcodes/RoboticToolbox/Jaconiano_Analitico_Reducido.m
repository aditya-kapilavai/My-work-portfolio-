...
syms a b c;
%DHmatrix(th,d,a,al)
Aditya= firsttest(4,2,2,a,b,c);
Aditya2=secondtest(1,0,1,a,b,c);
...
%DONDE Jg=[I     0 ]*Ja       Ja=Jacobiano Analitico Jg=Jacobiano geometrico 
...
%=[Ja(1:4,1) Ja(1:4,2) Ja(1:4,3) Ja(1:4,4)]

Ja_b=[Ja(1:3,1) Ja(1:3,2) Ja(1:3,3) Ja(1:3,4);
      Ja(6,1)   Ja(6,2)   Ja(6,3)   Ja(6,4)]

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% JACOBIANA INVERSA POR EL METODO DE LA PSEUDO-INVERSA IZQUIERDA %%
%% DONDE m>n ES DECIR TIENE MAS FILA(6) QUE COLUMNAS(4)           %% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
